  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-20 text-center px-6 max-w-5xl">
        <span className="hero-label block font-label text-xs uppercase tracking-[0.4em] text-surface mb-6 opacity-90">
          Paris · 1st Arrondissement
        </span>
        <h1 className="hero-title font-headline text-[40px] md:text-7xl lg:text-8xl text-surface leading-[1.05] mb-8 font-light">
          The Soul of Italy,<br />
          <span className="italic font-normal">the Heart of Paris</span>
        </h1>
        <p className="hero-body font-body text-lg md:text-xl text-surface/90 max-w-2xl mx-auto mb-10 font-normal leading-relaxed tracking-[0.01em]">
        ...
        <div className="hero-ctas flex flex-col sm:flex-row gap-6 justify-center">
          <a
            href="#reservations"
            className="bg-primary text-on-primary px-10 py-5 rounded-sm font-label text-xs uppercase tracking-[0.2em] transition-all hover:bg-primary-container inline-block text-center"
          >
            Reservations
          </a>
          <a
            href="#menu"
            className="border border-surface/30 backdrop-blur-md text-surface px-10 py-5 rounded-sm font-label text-xs uppercase tracking-[0.2em] transition-all hover:bg-surface hover:text-on-surface inline-block text-center"
          >
            View Menu
          </a>
        </div>
      </div>
      <div className="hero-accolade absolute bottom-12 left-12 z-20 hidden lg:block">
